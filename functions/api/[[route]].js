      ...
      if (stayId) {
        await DB.prepare(`
          UPDATE stayvibe_stays SET
            ...
            home_address = ?, home_address_line2 = ?, city = ?, state = ?, country = ?, from_city = ?, pincode = ?,
        ...
        `).bind(
          ...
          homeAddress||null, homeAddressLine2||null, city||null, state||null, country, fromCity||city||null, pincode||null,
        ...
        `).bind(
          ...
          parseInt(adults)||1, parseInt(children)||0,
          dob||null, gender||null, nationality,
          homeAddress||null, homeAddressLine2||null, city||null, state||null, country, fromCity||city||null,
          pincode||null,
          guestList||null, purposeOfVisit||null,
          modeOfTransport||null, vehicleNumber||null, eta||null,
          govtIdType||null, govtIdNum||null,
    ...
    await DB.prepare(`
      INSERT INTO stayvibe_flex_requests
        (request_id, villa_id, guest_name, contact, booking_channel,
         ...
         priority, wants_direct, requested_checkin_time, requested_checkout_time)
      VALUES (?,?,?,?,?,?,?,?,?,'new',?,?,?,?)
    `).bind(
      ...
      requestedCheckinTime || null, requestedCheckoutTime || null
    ).run()
