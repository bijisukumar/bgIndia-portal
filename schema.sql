...
, created_by TEXT DEFAULT 'owner', updated_by TEXT DEFAULT 'owner', drive_folder_url TEXT, review_rating    INTEGER DEFAULT 0, review_source    TEXT, review_date      TEXT, home_address TEXT, home_address_line2 TEXT, city TEXT, state TEXT, country TEXT DEFAULT 'India', from_city TEXT, pincode TEXT, govt_id_type TEXT, govt_id_num TEXT, cleaning_fee REAL DEFAULT 0, host_service_fee REAL DEFAULT 0, you_earn REAL DEFAULT 0, guest_service_fee REAL DEFAULT 0, night_fee REAL DEFAULT 0, guest_paid_total REAL DEFAULT 0, dob TEXT, gender TEXT, nationality TEXT DEFAULT 'Indian', purpose_of_visit TEXT, mode_of_transport TEXT, vehicle_number TEXT, eta TEXT, guest_list TEXT, checkin_form_submitted INTEGER DEFAULT 0, checkin_form_submitted_at TEXT, request_early_checkin  INTEGER DEFAULT 0, request_late_checkout  INTEGER DEFAULT 0, folder_created_at TEXT, processing_log    TEXT, folder_created INTEGER DEFAULT 0, extra_lines TEXT DEFAULT NULL, review_text TEXT DEFAULT NULL, review_note TEXT DEFAULT NULL, review_highlights TEXT DEFAULT NULL, review_chased_at TEXT DEFAULT NULL, review_chase_count INTEGER DEFAULT 0, review_closed INTEGER DEFAULT 0, notes TEXT, booked_by_guest_id TEXT, booked_by_name TEXT, cform_status TEXT DEFAULT 'not_required', guest_id   TEXT, enquiry_id TEXT, early_checkin_time TEXT DEFAULT NULL, late_checkout_time TEXT DEFAULT NULL, checkout_email_sent_at TEXT DEFAULT NULL, checked_in_by TEXT DEFAULT NULL, checked_out_by TEXT DEFAULT NULL, no_show INTEGER DEFAULT 0);
...
CREATE TABLE IF NOT EXISTS stayvibe_stay_ext (
  ...
  refund_amount REAL DEFAULT 0, refund_reason TEXT, refunded_at TEXT, refunded_by TEXT
);
