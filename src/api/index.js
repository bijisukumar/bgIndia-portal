...
export const api = {
  ...
  markNoShow:           (data)   => post('markNoShow', data),
  recordRefund:         (data)   => post('recordRefund', data),
  ...
  getAdvances:         (propId)  => get('getAdvances', { propId }),
  postAdvance:         (data)    => post('postAdvance', data),
  getMoveExpenses:     (propId)  => get('getMoveExpenses', { propId }),
  saveMoveExpense:     (data)    => post('saveMoveExpense', data),
  deleteMoveExpense:   (expenseId) => post('deleteMoveExpense', { expenseId }),
  ...
  markDepositPaid: (data) => post('markDepositPaid', data),
  ...
  getMonthlyNights:     (vId, years) => get('getMonthlyNights', { villaId: vId, years: years || 3 }),
  ...
  sendInviteAck:            (requestId, message, subject) => post('sendInviteAck', { requestId, message, subject }),
  ...
  cancelConfirmedEnquiry:    (data)   => post('cancelConfirmedEnquiry', data),
